...
return (
  <>
    ...
    <nav className="flex flex-wrap justify-start gap-2">
      ...
      <Link href="/login" className="text-gray-300 border border-gray-300 px-2 py-1 rounded hover:bg-gray-300 hover:text-gray-800 transition duration-300">Login</Link>
    </nav>
    <br/>
